...
export const About = () => {
  return (
    <Section id='sobre'>
      <div className="flex lg:flex-row flex-col items-center gap-8 text-gray-800 py-24">
        <div className="flex flex-col items-center lg:items-start py-4 w-full text-center lg:text-start lg:w-1/2">
        ...
        <div className="flex flex-col py-4 w-full lg:w-1/2 items-center bg-dark-blue-corpore pr-4 rounded-lg">
