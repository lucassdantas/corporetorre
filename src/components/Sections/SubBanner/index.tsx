  ...
  return (
    <Section className={'flex flex-col items-center w-full'}>
      <div className="flex w-full justify-between items-center text-sm  lg:mt-[-32px] text-white  gap-8">
        <div className="flex flex-col py-4 w-1/3 items-center justify-start text-center p-12  bg-blue-corpore rounded-xl shadow-lg ">
        ...
        <div className="flex flex-col py-4 w-1/3 items-center justify- text-center p-12  bg-blue-corpore rounded-xl shadow-lg   ">
          <CiMedicalCross className='text-xl' />
