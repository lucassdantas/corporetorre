...
import { FaAddressCard, FaFacebook, FaInstagram, FaMapMarkerAlt, FaWhatsapp } from 'react-icons/fa'
  ...
  return (
    <footer className='text-white'>
      <Section className='bg-dark-blue-corpore pt-24 pb-12'>
        <div className='flex text-lg '>
          <div className="w-2/4 flex flex-col gap-4 lg:pr-[15%]">
            <div className='bg-white rounded-xl flex justify-center shadow-lg p-4'>
          ...
          <div className="w-1/3 flex flex-col gap-4">
            ...
            <ul className=''>
              <li className='flex gap-4 items-center hover:scale-110 transition '><FaMapMarkerAlt className='text-2xl' /><a href={address.url} target='_blank' className='leading-4'>{address.info}</a></li>
      ...
      <Section className='bg-dark-blue-corpore'>
        <div className='text-center text-white text-lg border-t border-t-gray-300 py-4 flex justify-between items-center'>
