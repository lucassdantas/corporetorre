...
export const Button = ({content = 'Agendar consulta', url = whatsApp.url, target='_blank', fontSize='base', className=''}:ButtonProps) => {
  return (
    <Link href={url} target={target} className={"flex relative p-3  bg-green-500 rounded-xl  text-white font-bold items-center text-center justify-center gap-2 shadow-sm hover:bg-green-400 cursor-pointer transition duration-300 hover:scale-110 " + className}>
